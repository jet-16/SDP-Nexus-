...
<div class='admin-div' '>
  <div class='info-div'>
    ...
    <form action='admin.php' method='post'>
      ...
      <input type='text' name='searchboxa' placeholder='Search'>
    </form>
";
          include("conn.php");
          $searcha=isset($_POST['searchboxa']) ? $_POST['searchboxa']: '';
          {
            $result=mysqli_query($con,"SELECT * FROM users WHERE user_username LIKE '%". $searcha. "%'and user_role = 'admin'");
echo "
    <table>
