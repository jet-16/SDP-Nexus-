...
<section class="register-section">
  ...
  <h3>register</h3>
    <form class="register-form" action="register(dev).php" method="post" >
     <!-- <form class="register-form" action="register.php" method="post"></form>-->
        <div class="register-form-div">
          ...
          <div class="gender-div">
            ...
            <div class="contact-div">
              <h4>Contact</h4>
              <input type="text" name="contact" value="" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" required>
            </div>
          </div>
        ...
        <a href="register.php">Sign up as Member</a>
    </form>
  </div>
</section>
<!-- /Main Content -->
